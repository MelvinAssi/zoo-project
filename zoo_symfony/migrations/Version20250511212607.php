 ...
 */
final class Version20250511212607 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE users ALTER id_users DROP DEFAULT
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE users ALTER id_users SET DEFAULT 'gen_random_uuid()'
        SQL);
        $this->addSql(<<<'SQL'
